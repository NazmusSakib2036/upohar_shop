...
@section('title', 'সকল গিফট - উপহার Shop')
...
<div x-data="giftsPage()" class="pt-28 sm:pt-32">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div class="flex items-center gap-3 overflow-x-auto category-scroll pb-2">
            <a href="{{ route('gifts') }}"
               class="flex-shrink-0 px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-200 bg-brand-pink text-white shadow-md">
                সকল
            </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-800">সকল গিফট</h1>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            @empty
                <div class="col-span-full text-center py-16">
                    ...
                    <p class="text-gray-500 text-lg">এখনও কোনো পণ্য যোগ করা হয়নি।</p>
                </div>
            @endforelse
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <div class="aspect-square bg-gray-50 rounded-xl overflow-hidden mb-3">
                                <img :src="selectedImage || quickViewProduct.image || '/storage/app/public/products/placeholder.jpg'" class="w-full h-full object-cover" :alt="quickViewProduct.name">
                            </div>
...
function giftsPage() {
    return {
        ...
        addToCartById(id, qty) {
            if (!qty) {
                // Called from product card with just ID
